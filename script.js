...
const cardsData = [
    ...
    {
      title: 'TabMaster Pror',
      description: 'Organizes browser tabs into groups and sessions.',
      imageSrc: '/images/logo-tab-master-pro.svg',
    },
    {
      title: 'Viewport',
      description: 'Simulates various screen resolutions directly.',
      imageSrc: '/images/logo-viewport-buddy.svg',
    },
    {
      title: 'Markup Notes',
      description: ' efficientInspect and debug HTML and CSS layoutsly.',
      imageSrc: '/images/logo-markup-notes.svg',
    },
    {
      title: 'GridGuides',
      description: 'Overlay customizable grids and alignment guides on any webpage.',
      imageSrc: '/images/logo-grid-guides.svg',
    },
    {
